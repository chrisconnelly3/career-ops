...
export async function generateTailoredPdf(params: {
  ...
  const system = [
    ...
    "",
    "HTML STRUCTURE for projectsHtml (optional, omit by returning empty string). CRITICAL: do NOT include date ranges in the project-title (e.g. NEVER 'Conelo (2026 - Present)'). The 'Title (date range)' pattern triggers ATS work-experience misclassification because it mirrors the job-entry format. Put the date inline at the end of project-desc as plain prose:",
    '<div class="project"><span class="project-title">Project Name</span><div class="project-desc">Description text. Active 2024 – present.</div><div class="project-tech">Tech/context</div></div>',
    ...
    "",
    "HTML STRUCTURE for educationHtml (Workday and standard parsers expect school and degree on SEPARATE lines, not joined by an em-dash on one line):",
    '<div class="edu-item"><div class="edu-school"><span class="edu-org">San Jose State University</span></div><div class="edu-degree">B.A. in Chemistry, Spanish Minor</div></div>',
    "Do NOT fabricate a graduation year if cv.md does not specify one. Omit the year span entirely rather than guessing 'Graduated' or inventing a date. If cv.md has a year, append it as <span class=\"edu-year\">YYYY</span> inside .edu-item.",
    "",
